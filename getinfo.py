...
if __name__ == "__main__":
    ...
    URL2 = 'https://opendata.resas-portal.go.jp/api/v1/cities?prefCode={}'
    URL3 = 'http://wikipedia.simpleapi.net/api?keyword={}&output=xml'
